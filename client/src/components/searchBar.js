...
const SearchBar = (props) => {
  return (
            ...
            <form className="flex items-center mr-10">
                ...
                <div className="relative w-full">
                    ...
                    <input
                        onChange={props.handleFilterChange} type="text" id="simple-search" className="bg-white border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="Search" required />
                </div>
            </form>
